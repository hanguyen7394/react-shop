          ...
          <div className="row">
            ...
            <div className="col-sm-6 col-lg-2">
              <div className="widget">
                ...
                <Menu className="widget-list">
                  <li>
                    <NavLink to={PATHS.PAYMENT_METHODS}>Payment Methods</NavLink>
                  </li>
                  <li>
                    <NavLink to={PATHS.RETURNS}>Returns</NavLink>
                  </li>
                  <li>
                    <NavLink to={PATHS.SHIPPING}>Shipping</NavLink>
                  </li>
                  <li>
                    <NavLink to={PATHS.POLICY}>Privacy Policy</NavLink>
                  </li>
                </Menu>
              </div>
            </div>
            <div className="col-sm-6 col-lg-2">
              <div className="widget">
                ...
                <Menu className="widget-list">
                  <li>
                    <NavLink end to={PATHS.DASHBOARD.INDEX}>Account Details</NavLink>
                  </li>
                  <li>
      ...
      <div className="footer-bottom">
        <div className="container">
          <p className="footer-copyright">
            Copyright © 2023 {/* <a href="https://cfdcircle.vn/" target="_blank"> */}
